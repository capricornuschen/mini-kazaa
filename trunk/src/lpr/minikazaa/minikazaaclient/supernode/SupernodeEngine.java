...
public class SupernodeEngine implements Runnable {
    ...
    public void run() {
        ...
        SupernodeRMIManager sn_rmi = new SupernodeRMIManager(my_conf,sn_list,main_gui);
        Thread rmi_manager = new Thread(sn_rmi);
        rmi_manager.start();
        
        //Init TCP requests manager
        SupernodeTCPListener listener_tcp = new SupernodeTCPListener(this.my_conf,sn_list,on_files,main_gui);
