...
\title{\begin{figure}
 \centering
 \includegraphics[width=200px,height=200px,bb=14 14 215 215]{images/mini-logo.eps}
 % mini-logo.eps: 0x0 pixel, 300dpi, 0.00x0.00 cm, bb=14 14 215 215
 \label{fig:logo}
\end{figure}
...
%per la grafica
\input{Gui_Package.tex}
\input{scelte_di_progetto.tex}
\appendix
\input{manuale_uso.tex}
\end{document}
